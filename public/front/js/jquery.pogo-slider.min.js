...
(function (d, f, g, a) {
    ...
    h.prototype = {
        ...
        _createSlideSlices: function (A, q, r) {
            ...
            C.children()
                .wrapAll('<div class="pogoSlider-slide-slice" style="' + "width:" + n + "%;height:" + l + "%;top:0%;left:0%;" + '"/>')
                .wrapAll('<div class="pogoSlider-slide-slice-inner" style="' + B + "width:" + t + "%;height:" + s + "%;top:0%;left:0%;" + '"/>');
