...
@section('title', 'Manage Banner Slider Details ')
                        ...
                        <table id="example" class="display expandable-table" style="width:100%">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>@if($D->status==1) <a href="{{url('Accounts/status-change/0/'.dEncrypt($D->id).'/banner_sliders')}}" style="color:green;">Active</a> @else <a href="{{url('Accounts/status-change/1/'.dEncrypt($D->id).'/banner_sliders')}}" style="color:red;">Inactive</a> @endif</td>
