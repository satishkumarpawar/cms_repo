...
@section('title', 'Manage QuickLinks ')
            ...
            <div class="col-md-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-title">Manage QuickLinks </p>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              @endif</td>
                               ...
                               <td>@if($D->status==1) <a href="{{url('Accounts/status-change/0/'.dEncrypt($D->id).'/quick_links')}}" style="color:green;">Active</a> @else <a href="{{url('Accounts/status-change/1/'.dEncrypt($D->id).'/quick_links')}}" style="color:red;">Inactive</a> @endif</td>

                              <td>  <a href="{{url('Accounts/add-edit-quicklink/'.dEncrypt($D->id))}}"><i class="ti-pencil btn-icon-append" style="color:black;"></i></a> &nbsp;
