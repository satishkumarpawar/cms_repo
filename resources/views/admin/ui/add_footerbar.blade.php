           ...
           <div class="col-md-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <h4 class="card-title">Add Menu Bar</h4>
                 ...
                 @endif 
                  ...
                  <form class="forms-sample row col-md-12" method="POST" action="{{route('admin.addfooter')}}" enctype="multipart/form-data">
