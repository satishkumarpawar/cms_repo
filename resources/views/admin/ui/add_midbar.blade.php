...
@section('title', 'Add Slider Layout')
           ...
           <div class="col-md-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <h4 class="card-title">Add Slider Layout</h4>
                 ...
                 @endif 
                  ...
                  <form class="forms-sample row col-md-12" method="POST" action="{{route('admin.addmidbar')}}" enctype="multipart/form-data">
