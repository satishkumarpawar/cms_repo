...
@section('title', 'Add Header Layout')
           ...
           <div class="col-md-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <h4 class="card-title">Add Header Layout</h4>
                 ...
                 @endif 
                  ...
                  <form class="forms-sample row col-md-12" method="POST" action="{{route('admin.addtopbar')}}" enctype="multipart/form-data">
