...
@section('title', 'Add USP Section Layout')
           ...
           <div class="col-md-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <h4 class="card-title">Add USP Section Layout</h4>
                 ...
                 @endif 
                  ...
                  <form class="forms-sample row col-md-12" method="POST" action="{{route('admin.addusp')}}" enctype="multipart/form-data">
