...
@section('title', 'Manage About Section Layout')
            ...
            <div class="col-md-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-title">Manage About Section Layout</p>

                  <div>

                      <button type="button" class="btn btn-primary" ><a href="{{route('admin.addabout_h')}}">Add New About Section Layout</a></button>
