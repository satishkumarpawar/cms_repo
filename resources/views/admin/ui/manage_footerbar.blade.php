...
@section('title', 'Manage Footer Layouts')
            ...
            <div class="col-md-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-title">Manage Footer Layouts</p>

                  <div>

                      <button type="button" class="btn btn-primary" ><a href="{{route('admin.addfooter')}}">Add New Footer Layout</a></button>
