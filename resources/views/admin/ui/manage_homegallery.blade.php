...
@section('title', 'Manage Gallery Layout')
            ...
            <div class="col-md-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-title">Manage Gallery Layout</p>

                  <div>

                      <button type="button" class="btn btn-primary" ><a href="{{route('admin.addhomegallery')}}">Add New Gallery Layout</a></button>
