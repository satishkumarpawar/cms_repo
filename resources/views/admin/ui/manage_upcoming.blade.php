...
@section('title', 'Manage Upcoming Section Layout')
            ...
            <div class="col-md-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-title">Manage Upcoming Section Layout</p>

                  <div>

                      <button type="button" class="btn btn-primary" ><a href="{{route('admin.addupcoming')}}">Add New Upcoming Section Layout</a></button>
