...
@section('title', 'Manage USP Section Layout')
            ...
            <div class="col-md-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-title">Manage USP Section Layout</p>

                  <div>

                      <button type="button" class="btn btn-primary" ><a href="{{route('admin.addusp')}}">Add New USP Section Layout</a></button>
